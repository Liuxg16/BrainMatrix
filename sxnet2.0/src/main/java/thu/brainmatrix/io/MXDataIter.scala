...
import thu.brainmatrix.{DataPack, DataBatch, DataIter, NDArray, Shape}
import thu.brainmatrix.IO._
...
class MXDataIter private[brainmatrix](private[brainmatrix] val handle: DataIterHandle,
