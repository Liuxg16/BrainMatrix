...
//by lxg
typedef void *OperatorPropertyHandle;
typedef void *StaticGraphHandle;
...
//by liuxianggen
// 2016-3-9
MXNET_DLL int MXScalaOpListArguments(AtomicSymbolCreator creator,//the function handle
...
// by liuxianggen
// 2015-3-8
MXNET_DLL int MXScalaOpInit(OperatorPropertyHandle OpHandle,
                               mx_uint num_param,
                               const char **keys,
                               const char **vals);
//2015-3-9
MXNET_DLL int MXScalaOpPrintParam(OperatorPropertyHandle OpHandle);
 ...
 * \return 0 when success, -1 when failure happens
 */
MXNET_DLL int MXScalaSGInferShape(StaticGraphHandle handle,
...
MXNET_DLL int MXScalaOPCopy(OperatorPropertyHandle ophandle,OperatorPropertyHandle *out);
 ...
 */
MXNET_DLL int MXScalaToStaticGraph(StaticGraphHandle *handle,int *arg_node_sg,int arg_node_sg_len,int heads_len,int *heads_source,int *heads_index,
...
MXNET_DLL int MXScalaExecutorBind(StaticGraphHandle sg_handle,
                   int dev_type,
                   int dev_id,
                   mx_uint len,
                   NDArrayHandle *in_args,
...
MXNET_DLL int MXScalaExecutorBindX(StaticGraphHandle sg_handle,
        int dev_type,
        int dev_id,
        mx_uint num_map_keys,
        const char** map_keys,
        ...
        NDArrayHandle *aux_states,
        ExecutorHandle *out);
//by liuxianggen scala
MXNET_DLL int MXNDArraySetData(NDArrayHandle handle,int index,float source);


//by lxg

MXNET_DLL int MXSymbolPrintVector(mx_uint len,mx_uint *nums);


//lxg
MXNET_DLL int MXScalaSymbolIsAtomic(SymbolHandle symbol,mx_uint *out);
